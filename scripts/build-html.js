...
<style id="atkinsrealis-transportation-theme">
  ...
  /* === EDITORIAL CONSULTING SYSTEM: OPEN LAYOUTS, NOT DASHBOARD CARDS === */
  #deck.slides-offset > section.slide:not(.mck-cover)::before {
    border-width: clamp(0.55rem, 1.3vw, 1.15rem);
    opacity: 0.58;
  }
  #deck.slides-offset > section.slide:not(.mck-cover)::after {
    width: clamp(0.16rem, 0.25vw, 0.24rem);
    height: clamp(2rem, 7vh, 3.7rem);
  }
  .mck-card-grid {
    gap: clamp(1rem, 2vw, 2rem);
  }
  .mck-card {
    ...
    border: 0;
    border-top: 1px solid var(--line);
    padding: clamp(0.72rem, 1vw, 1rem) clamp(0.25rem, 0.55vw, 0.55rem) 0;
  }
  .mck-card::after {
    ...
    right: 0.2rem;
    top: 0.35rem;
    color: rgba(24,45,56,.28);
    font-size: clamp(0.48rem, 0.62vw, 0.62rem);
    font-weight: 750;
    letter-spacing: .08em;
  }
  .mck-card:nth-child(3n+1) { border-top-color: var(--primary-2); }
  .mck-card:nth-child(3n+2),
  .mck-card:nth-child(3n+3) { border-top-color: var(--line); }
  #deck .slide[data-source-slide="15"] .mck-card:last-child,
  #deck .slide[data-source-slide="20"] .mck-card:first-child,
  #deck .slide[data-source-slide="25"] .mck-card:last-child {
    background: rgba(5,229,96,.07);
    padding-left: clamp(0.75rem, 1.2vw, 1.1rem);
    padding-right: clamp(0.75rem, 1.2vw, 1.1rem);
  }
  #deck .slide[data-source-slide="16"] .mck-card {
    background: transparent;
  }
  .mck-source-note {
    border-top-color: rgba(24,45,56,.18);
  ...
  .mck-image-panel::after {
    ...
    color: var(--navy);
    padding: 0.35rem 0 0;
    font-size: clamp(0.42rem, 0.55vw, 0.56rem);
    border-top: 1px solid rgba(255,255,255,.7);
  }
  .mck-image-panel img {
    box-shadow: none;
  }
  #deck .slide[data-source-slide="3"] .mck-image-panel img,
  #deck .slide[data-source-slide="22"] .mck-image-panel img,
  #deck .slide[data-source-slide="25"] .mck-image-panel img {
    object-position: center;
  }
  ...
  .mck-agenda-item {
    ...
    border: 0;
    border-top: 1px solid var(--line);
    padding: clamp(0.7rem, 1vw, 0.95rem) 0;
    gap: clamp(0.7rem, 1vw, 1rem);
  }
  .mck-agenda-item:nth-child(1),
  .mck-agenda-item:nth-child(2) { border-top-color: var(--primary-2); }
  .mck-agenda-num {
  ...
  .mck-lead {
    ...
    border: 0;
    border-left: 2px solid var(--primary-2);
    padding: 0.15rem 0 0.15rem clamp(0.7rem, 1vw, 1rem);
  }
  .mck-timeline {
  ...
  .mck-timeline-card {
    ...
    border: 0;
    border-top: 1px solid var(--line);
    padding: clamp(0.65rem, 0.9vw, 0.9rem) 0 0;
  }
  .mck-timeline-card::before {
    width: clamp(0.55rem, 0.8vw, 0.8rem);
    height: clamp(0.55rem, 0.8vw, 0.8rem);
    top: calc(-1 * clamp(0.28rem, 0.4vw, 0.4rem));
    bottom: auto;
    border-radius: 50%;
    background: var(--primary-2);
  }
  .mck-timeline-card:nth-child(even)::before { background: var(--teal); }
  ...
  .mck-role-card {
    ...
    border: 0;
    border-top: 1px solid var(--line);
    padding: clamp(0.6rem, 0.9vw, 0.85rem) 0 0;
  }
  .mck-role-card:nth-child(1) { border-top-color: var(--primary-2); }
  .mck-role-index {
    display: block;
    margin-bottom: 0.2rem;
    color: rgba(24,45,56,.35);
  }
  ...
  .mck-concept {
    ...
    border: 0;
    border-top: 1px solid var(--line);
    padding: clamp(0.65rem, 1vw, 0.9rem) 0 0;
  }
  .mck-concept-step {
    background: transparent;
    border: 0;
  ...
  .mck-concept-step.is-blue { border-bottom-color: var(--primary-2); }
  .mck-concept-step.is-green { border-bottom-color: var(--teal); }
  .mck-balance-mark {
    background: transparent;
    color: var(--teal);
  ...
  .mck-source-column {
    ...
    border: 0;
    border-left: 1px solid var(--line);
    padding: 0 0 0 clamp(0.75rem, 1.1vw, 1rem);
  }
  .mck-source-column:first-child {
    border-left: 0;
    padding-left: 0;
  }
  ...
  .stage-2 .mck-stage-label {
    background: transparent;
    color: var(--primary-2);
  }
  .stage-3 {
    background: rgba(5,229,96,.075);
    padding: 0 clamp(0.7rem, 1vw, 1rem);
  }
  .stage-3 .mck-stage-label {
    background: transparent;
    color: var(--navy);
